bot = dofile('/home/Goldcli/data/utils.lua')
json = dofile('/home/Goldcli/data/JSON.lua')
...
-- mods
   ...
   -- member
   if text == 'ping' then
          local a = {"<code>نزن کزکش </code>","<code>ربات فعال است</code>","<b>pong!</b>"}
